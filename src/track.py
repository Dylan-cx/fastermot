...
if __name__ == '__main__':
    ...
    #      data_root=data_root,
    #      seqs=seqs,
    #      #exp_name='MOT17_chongxun_180_test_zuiyou_test_no_p_0_4',
    #      exp_name='MOT17_visual_180_val_zuiyou_val_no_p_0_4',
    #      show_image=False,
    #      save_images=True,
    #      save_videos=True)
    if opt.test_NEU:
        ...
        #seqs_str = '''MOT16-01 MOT16-07 MOT16-12 MOT16-14'''
        #seqs_str = '''MOT16-06 MOT16-08'''
        data_root = os.path.join(opt.data_dir, 'NEU-MOT/images/test')
    seqs = [seq.strip() for seq in seqs_str.split()]
    main(opt,
         data_root=data_root,
         seqs=seqs,
         exp_name='mot_17_val_bytepatch_01',
         show_image=False,
         save_images=True,
         save_videos=True)