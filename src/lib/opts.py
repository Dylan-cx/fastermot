...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--load_model', default='',
                             help='path to pretrained model')
    self.parser.add_argument('--load_model1', default='',
                             help='path to pretrained model')
    ...
    # model
    #新填加的
    self.parser.add_argument("--attention_type", type=str, default="dfc",
                        help="attention type in building block (possible choices none | se | cbam | simam )")


    self.parser.add_argument('--arch', default='fasterdfc_1242',
                             help='model architecture. Currently tested'
                                  'resdcn_34 | resdcn_50 | resfpndcn_34 |'
                                  'dla_34 | hrnet_18 | fasternet_t0 | ghost_004 | fsc_t0')
    ...
    self.parser.add_argument('--batch_size', type=int, default=28,
                             help='batch size')
    ...
    self.parser.add_argument('--test_NEU', default=False, help='test NEU')
  ...
  #  self.parser.add_argument('--data_dir', type=str, default='/home/extend/yanhao/fairmot/src/lib/cfg/data')
  #   self.parser.add_argument('--data_dir', type=str, default='/home/extend/zhy/code/ocsort/datasets')
    self.parser.add_argument('--data_dir', type=str, default='/home/robot112/fastermot/src/lib/cfg/data')
    ...
    self.parser.add_argument("--match_thres", default=0.4, type=float, help="byte+moton first match thresh")

    self.parser.add_argument('--proximity_thresh', type=float, default=0.5, help='threshold for rejecting low overlap reid matches')
    self.parser.add_argument('--appearance_thresh', type=float, default=0.25, help='threshold for rejecting low appearance similarity reid matches')
